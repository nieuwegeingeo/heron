...
Heron.ngein.layermap = {
	...
	**/
    ...
    projectenkaart: new OpenLayers.Layer.WMS("Projectenkaart",
      Heron.PDOK.urls.NGEINGEOSERVER,
      {
		  layers: 'nieuwegein:projectenkaartvlakken,nieuwegein:projectenkaartlijnen,nieuwegein:projectenkaartpunten',
		  format: "image/png", 
		  transparent: true
	  },
      {	  isBaseLayer: false, singleTile: true,  visibility: false
		  ...
		  ,metadata:{
					...
					html: 'Meer informatie over de projectenkaart vind je: <a target="nwwindow" href="./metadata/Metadata_Stadsmonitor.htm#Projectenkaart">hier</a>' // metadata as html (will be place between <p></p>)		   
				}
      }
    ),
