        ...
        if (a.nodeType == "gx_layer") {
            ...
            if (this.node.layer.layerIcons == 'secure'){
                ...
                function checkGeoserver(e) {
                    ...
                    var req = '//' + location.host +'/geoserver/wfs?request=getFeature&typeName=nieuwegein:secure_layer_check_wa&BBOX=134275,448949,134276,448950&WIDTH=10&HEIGHT=10&format=image/png'
                    $(function(){
                        $.ajax({
