...
Heron.widgets.search.SpatialSearchPanel = Ext.extend(Ext.Panel, {
    ...
    layerFilter: function (map) {
         ...
         */
        layers = map.getLayersBy('metadata',
            {
        ...
        // RD feb 2017: return only layers that are currently visible
        // RD juli 2021: toch weer alle wfs layers laten zien, want er is 
        //   geen mogelijkheid om de dropdown te herbouwen bij het zichtbaar maken van een laag
