...
// -------------------------------------------
// Nieuwegein: er waren CORS problemen bij GetFeatureInfo (AJAX) requests naar service.pdok.nl
// via https://github.com/ckan/ckanext-geoview/issues/28
// kwamen we erachter dat dat komt omdate er ALTIJD een 'x-requested-with' werd meegegeven
// door OpenLayers aan requests, en dat vinden moderne browsers niet meer goed.
// Dit hieronder is dus een override van de issue-functie uit OpenLayers.Request.js, waarbij
// we in het geval van een GET requets die header NIET mee te sturen
...
OpenLayers.Request.issue = function(config) {        
        ...
        if (customRequestedWithHeader === false) {
            ...
            // FIX NIEUWEGEIN: check for method!==GET
