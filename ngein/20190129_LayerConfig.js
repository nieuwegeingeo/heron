       ...
       gridcolumns: [
                {
                    ...
                    columns: [
						...
						{ dataIndex: "EIGENAAR", header: 'Eigenaar', width: 300 },
                    ]
                }
            ]
		   ,
...
//                        { dataIndex: "EIGENAAR_NAAM", header: 'EIGENAAR_NAAM', width: 200 },
   ...
   /* ------------------------------
    ...
    warmte_gasaansluiting: new OpenLayers.Layer.WMS("Warmte en Gasaansluitingen",
      ...
      {isBaseLayer: false, singleTile: true,
       visibility: false,
       legendURL: "http://gng-ap713.nieuwegein.nl/geoserver/wms?REQUEST=GetLegendGraphic&VERSION=1.0.0&FORMAT=image/png&WIDTH=20&HEIGHT=20&STRICT=false&style=panden_indicatie_gas_warmte_style"
      }
    ),
